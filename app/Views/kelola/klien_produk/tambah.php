        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tambah Klien Produk</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-basic-single col-sm-12" id="no_klien" name="no_klien" required>
                                            ...
                                            <?php foreach ($kliens as $klien): ?>
                                                <option value="<?= $klien->no_klien; ?>"><?= $klien->no_klien; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="nama_klien" name="nama_klien" placeholder="Nama Klien" readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="deskripsi" name="deskripsi" placeholder="Deskripsi" readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Tanggal Pakai</label>
                                    <div class="col-sm-9">
                                        <input class="form-control digits" type="date" id="tgl_pakai" name="tgl_pakai">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Tanggal Jatuh Tempo</label>
                                    <div class="col-sm-9">
                                        <input class="form-control digits" type="date" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Jangka Waktu</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="jangka_waktu" name="jangka_waktu" placeholder="Jangka Waktu" readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Biaya Setup</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="biaya_setup" name="biaya_setup" placeholder="Biaya Setup">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Biaya Bulanan</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="biaya_bulanan" name="biaya_bulanan" placeholder="Biaya Bulanan">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Biaya Cloud</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="biaya_cloud" name="biaya_cloud" placeholder="Biaya Cloud">
                                    </div>
                                </div>
                                <div class="mb-3 row">
