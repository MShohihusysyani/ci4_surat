    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <?php if (!empty($kliens) && is_array($kliens)): ?>
                    <?php $klien = $kliens; // Fetch the first (and possibly only) client 
                    ?>
                    <form class="form theme-form" action="/kelola/klien/update/<?= $klien['id_klien'] ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="no_klien" name="no_klien" placeholder="Kode Klien" value="<?= $klien['no_klien'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Nama Klien</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="nama_klien" name="nama_klien" placeholder="Nama Klien" value="<?= $klien['nama_klien'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="alamat" name="alamat" placeholder="Alamat" value="<?= $klien['alamat'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single col-sm-12" id="provinsi" name="provinsi" required>
                                                ...
                                                <?php foreach ($provinsi as $prov): ?>
                                                    <option value="<?= $prov['id_wilayah_propinsi'] ?>" <?= ($prov['id_wilayah_propinsi'] == $klien['provinsi']) ? 'selected' : '' ?>>
                                                        <?= $prov['nama_propinsi'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single col-sm-12" id="kabupaten" name="kabupaten" required>
                                                ...
                                                <?php foreach ($kabupaten as $kab): ?>
                                                    <option value="<?= $kab['id_wilayah_kabupaten'] ?>" <?= ($kab['id_wilayah_kabupaten'] == $klien['kabupaten']) ? 'selected' : '' ?>>
                                                        <?= $kab['nama_kabupaten'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single col-sm-12" id="kecamatan" name="kecamatan" required>
                                                ...
                                                <?php foreach ($kecamatan as $kec): ?>
                                                    <option value="<?= $kec['id_wilayah_kecamatan'] ?>" <?= ($kec['id_wilayah_kecamatan'] == $klien['kecamatan']) ? 'selected' : '' ?>>
                                                        <?= $kec['nama_kecamatan'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single col-sm-12" id="kelurahan" name="kelurahan" required>
                                                ...
                                                <?php foreach ($kelurahan as $kel): ?>
                                                    <option value="<?= $kel['id_wilayah_kelurahan'] ?>" <?= ($kel['id_wilayah_kelurahan'] == $klien['kelurahan']) ? 'selected' : '' ?>>
                                                        <?= $kel['nama_kelurahan'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single col-sm-12" id="kode_pos" name="kode_pos" required>
                                                ...
                                                <?php foreach ($kodepos as $kop): ?>
                                                    <option value="<?= $kop['id_wilayah_kelurahan'] ?>" <?= ($kop['id_wilayah_kelurahan'] == $klien['kode_pos']) ? 'selected' : '' ?>>
                                                        <?= $kop['kode_pos'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="nama_dirut" name="nama_dirut" placeholder="Nama Dirut" value="<?= $klien['nama_dirut'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">No HP Dirut</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="number" id="no_hp_dirut" name="no_hp_dirut" placeholder="No HP Dirut" value="<?= $klien['no_hp_dirut'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Nama Dirops</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="nama_dirops" name="nama_dirops" placeholder="Nama Dirops" value="<?= $klien['nama_dirops'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Nama PIC</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="nama_pic" name="nama_pic" placeholder="Nama PIC" value="<?= $klien['nama_pic'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">No HP PIC</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="number" id="no_hp_pic" name="no_hp_pic" placeholder="No HP PIC" value="<?= $klien['no_hp_pic'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">No Telp</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="number" id="no_telp" name="no_telp" placeholder="No Telp" value="<?= $klien['no_telp'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="email" name="email" placeholder="Email" value="<?= $klien['email'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Website</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="website" name="website" placeholder="Website" value="<?= $klien['website'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Tanggal Bergabung</label>
                                        <div class="col-sm-9">
                                            <input class="form-control digits" type="date" id="tgl_bergabung" name="tgl_bergabung" value="<?= $klien['tgl_bergabung'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Tanggal Nonaktif</label>
                                        <div class="col-sm-9">
                                            <input class="form-control digits" type="date" id="tgl_nonaktif" name="tgl_nonaktif" value="<?= $klien['tgl_nonaktif'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
