                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-basic-single col-sm-12" id="surat_dari" name="surat_dari">
                                            ...
                                            <option value="Klien MSO">Klien MSO</option>
                                            <option value="Non MSO">Non MSO</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control digits" type="date" id="tgl_terima" name="tgl_terima" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
