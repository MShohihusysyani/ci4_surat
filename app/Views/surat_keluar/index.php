        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header pb-0 card-no-border">
                    <h3>Surat Keluar</h3>
                    <a href="suratkeluar/tambah" class="btn btn-primary"> <i class="icon-plus"></i></a>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <?php if ($suratkeluar->progres == 'proses draft' || $suratkeluar->progres == 'draft' || $suratkeluar->progres == 'revisi-1' || $suratkeluar->progres == 'revisi-2' || $suratkeluar->progres == 'revisi-3') : ?>
                                                        <li>
                                                            <a class="dropdown-item" href="suratkeluar/edit/<?= $suratkeluar->id_surat_keluar ?>">
                                                                <i class="icon-pencil-alt"></i> Edit
                                                            </a>
                                                        </li>
                                                        <li class="dropdown-item"><a href="suratkeluar/hapus/<?= $suratkeluar->id_surat_keluar ?>" class="tombol-hapus"><i class="icon-trash"></i> Hapus</a></li>
                                                    <?php endif; ?>
