                    ...
                    <div class="card widget-1">
                        <div class="card-body">
                            <div class="widget-content">
                                ...
                                <div>
                                    <h4>
                                        <?php foreach ($total_surat_masuk_klien as $k) : ?>
                                            <?= $k->total_surat_masuk_klien; ?>
                                        <?php endforeach; ?>
                                    </h4>
                                    <span class="f-light">Surat Keluar</span>
                                </div>
                            </div>
                        ...
                        <div class="card widget-1">
                            <div class="card-body">
                                <div class="widget-content">
                                    ...
                                    <div>
                                        <h4>4,200</h4><span class="f-light">Surat Masuk</span>
                                    </div>
                                </div>
                    ...
                    <div class="card widget-1">
                        <div class="card-body">
                            <div class="widget-content">
                                ...
                                <div>
                                    <h4>
                                        <?php foreach ($total_surat_keluar_klien as $k) : ?>
                                            <?= $k->total_surat_keluar_klien; ?>
                                        <?php endforeach; ?>
                                    </h4>
                                    <span class="f-light">Surat Masuk</span>
                                </div>
                            </div>
                            <!-- <div class="font-warning f-w-500"><i class="icon-arrow-down icon-rotate me-1"></i><span></span></div> -->
                        </div>
                    </div>
                    <!-- <div class="col-xl-12">
                        <div class="card widget-1">
