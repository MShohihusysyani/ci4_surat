        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" src="<?= base_url() ?>/assets/images/dashboard/profile.png" alt="">
            <div class="media-body"><span><?= session('nama_user') ?></span>
              <p class="mb-0 font-roboto"><?= session('role') ?> <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="<?= base_url('logout') ?>" class="tombol-logout"><i data-feather="log-out"> </i><span>Log out</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
