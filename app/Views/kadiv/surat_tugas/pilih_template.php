    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <input type="hidden" name="id_surat_tugas" id="id_surat_tugas" value="<?= $id_surat_tugas ?>">
                    <div class="row">
                        <div class="col">
                            <div class="mb-3 row">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelector(".btn-primary").addEventListener("click", function() {
            ...
            if (selectedTemplate === "") {
                ...
                window.location.href = "<?= base_url('kadiv/surat-tugas/preview-template') ?>/" + selectedTemplate;
            }
        });
    });
</script>
